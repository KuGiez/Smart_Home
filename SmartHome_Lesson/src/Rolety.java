...
public class Rolety extends SmartDevice {
    ...
    public void wysun(double wys) {
        ...
        JOptionPane.showMessageDialog(null,name + ": Rolety wysunięte w " + (int)(stopienWysuniecia * 100) + "%.");
    }

    public float getStopienWysuniecia() {
        return stopienWysuniecia;
    }
    ...
    public void showStatus() {
        ...
        JOptionPane.showMessageDialog(null,name + " | Stan: " + stan);
    }
}
